            ...
            <main className="page__content page__content--narrow">
                <div className="page__header">
                    <div>
                        ...
                        <p className="page__subtitle">Describe what you need done and a Genie will help</p>
                    </div>
                </div>
                ...
                <div className="form-card">
                    <form onSubmit={handleSubmit} noValidate>
                        ...
                        {/* Price */}
                        <div className="form-group">
                            <label className="form-label" htmlFor="job-price">Budget (₹)</label>
                            ...
                            {priceHint && (
                                <div className="price-hint">
                                    ...
                                    {priceHint.reasoning && (
                                        <span className="price-hint__reason"> — {priceHint.reasoning}</span>
                                    )}
                                </div>
                            )}
                        </div>

              ...
              <div className="landing__stories-grid">
                ...
                <figure className="landing__story-card landing__story-card--orange">
                  ...
                  <blockquote className="landing__story-quote">
                    ...
                    getting paid anymore. Job done = instant release. Simple.&quot;
                  </blockquote>
                  <figcaption className="landing__story-author">
                ...
                <figure className="landing__story-card landing__story-card--blue">
                  <div className="landing__story-rating">⭐⭐⭐⭐⭐</div>
                  <blockquote className="landing__story-quote">
                    &quot;Made $400 last weekend doing yard cleanups. Love that I
                    can choose which jobs to take and see ratings before accepting.&quot;
                  </blockquote>
                  <figcaption className="landing__story-author">
                    <div className="landing__story-avatar">J</div>
          ...
          <footer className="landing__footer">
            <div className="landing__footer-grid">
              <div className="landing__footer-section">
                ...
                <p className="landing__footer-tagline">
                  The community platform for people who want real-world help, fast.
                </p>
                <div className="landing__footer-social">
                  <a href="https://github.com/do4u" target="_blank" rel="noopener noreferrer" className="landing__footer-social-link">
                  ...
                  <a href="https://twitter.com/do4u" target="_blank" rel="noopener noreferrer" className="landing__footer-social-link">
                    <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                    </svg>
                  </a>
                  <a href="https://linkedin.com/company/do4u" target="_blank" rel="noopener noreferrer" className="landing__footer-social-link">
                    <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                    </svg>
                  </a>
                  <a href="https://instagram.com/do4u" target="_blank" rel="noopener noreferrer" className="landing__footer-social-link">
                    <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="landing__footer-section">
                ...
                <div className="landing__footer-links">
                  <a href="#home" className="landing__footer-link">Home</a>
                  <a href="#how-it-works" className="landing__footer-link">How it Works</a>
                  <a href="#stories" className="landing__footer-link">Stories</a>
              ...
              <div className="landing__footer-section">
                ...
                <div className="landing__footer-links">
                  <Link to="/login?role=user" className="landing__footer-link">Post a Task</Link>
                  <Link to="/login?role=genie" className="landing__footer-link">Become a Genie</Link>
                  <Link to="/register" className="landing__footer-link">Create Account</Link>
                </div>
              </div>
              ...
              <div className="landing__footer-section">
                ...
                <div className="landing__footer-contact">
                  <p className="landing__footer-contact-item">
                    ...
                    <a href="mailto:hello@do4u.app" className="landing__footer-link">hello@do4u.app</a>
                  </p>
                  <p className="landing__footer-contact-item">
                    <strong>📞 Phone:</strong><br/>
                    <a href="tel:+15551234567" className="landing__footer-link">+1 (555) 123-4567</a>
                  </p>
                  <p className="landing__footer-contact-item">
            ...
            <div className="landing__footer-bottom">
              ...
              <div className="landing__footer-bottom-links">
                <a href="#privacy" className="landing__footer-link">Privacy Policy</a>
                <a href="#terms" className="landing__footer-link">Terms of Service</a>
              </div>
            </div>
          </footer>
        </main>
